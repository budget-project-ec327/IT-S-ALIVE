...
ListWidget::ListWidget(QWidget *parent) : QWidget(parent) {
    ...
    //    series->append("Food", 4);
    //    series->append("Monthly Bills", 7);
    //    series->append("Fun", 2);
    //    series->append("Transportation", 5);
    //    series->append("Medical", 4);
    //    series->append("Other", 2);
    //    series->append("Remaining", 9);

    //    QPieSlice *foodslice = series->slices().at(0);
    //    foodslice->setExploded();
    //    foodslice->setLabelVisible();
    //    //foodslice->setPen(QPen(Qt::darkGreen, 2));
    //    //foodslice->setBrush(Qt::green);

    //    QPieSlice *billslice = series->slices().at(1);
    //    billslice->setExploded();
    //    billslice->setLabelVisible();
    //    //          billslice->setPen(QPen(Qt::darkGreen, 2));
    //    //          billslice->setBrush(Qt::green);

    //    QPieSlice *funslice = series->slices().at(2);
    //    funslice->setExploded();
    //    funslice->setLabelVisible();
    //    //          funslice->setPen(QPen(Qt::darkGreen, 2));
    //    //          funslice->setBrush(Qt::green);

    //    QPieSlice *translice = series->slices().at(3);
    //    translice->setExploded();
    //    translice->setLabelVisible();
    //    //          translice->setPen(QPen(Qt::darkGreen, 2));
    //    //          translice->setBrush(Qt::green);

    //    QPieSlice *medslice = series->slices().at(4);
    //    medslice->setExploded();
    //    medslice->setLabelVisible();
    //    //          medslice->setPen(QPen(Qt::darkGreen, 2));
    //    //          medslice->setBrush(Qt::green);

    //    QPieSlice *otherslice = series->slices().at(5);
    //    otherslice->setExploded();
    //    otherslice->setLabelVisible();
    //    //          otherslice->setPen(QPen(Qt::darkGreen, 2));
    //    //          otherslice->setBrush(Qt::green);

    //    QPieSlice *leftslice = series->slices().at(6);
    //    leftslice->setExploded();
    //    //leftslice->setLabelVisible();
    //    leftslice->setPen(QPen(Qt::darkGreen, 2));
    ...
    //itemname->resize(100,50);
    // itemname->setFont(QFont("Times", 16, QFont::Bold));
    // itemname->setStyleSheet("QLabel { background-color : rgb(255, 165, 255); color : black; }");
    QLabel *itemid=new QLabel("Item ID");
    // itemid->setFont(QFont("Times", 16, QFont::Bold));
    // itemid->setStyleSheet("QLabel { background-color : rgb(255, 165, 255); color : black; }");
    QLabel *itemcategory=new QLabel("Category");
    // itemcategory->setFont(QFont("Times", 16, QFont::Bold));
    // itemcategory->setStyleSheet("QLabel { background-color : rgb(255, 165, 255); color : black; }");
    QLabel *itemvalue=new QLabel("Amount (USD)");
    // itemvalue->setFont(QFont("Times", 16, QFont::Bold));
    // itemvalue->setStyleSheet("QLabel { background-color : rgb(255, 165, 255); color : black; }");
    ...
    //QSpacerItem *spacer3 = new QSpacerItem(1, 35, QSizePolicy::Maximum, QSizePolicy::Maximum);
